# MAGPAI – Session 02 – Next Token Prediction – v1.0
...
- pptx/session-02-next-token-prediction.pptx
- diagrams/source/
- notebooks/session-02-next-token-prediction.ipynb
- src/magpai/
- apps/streamlit/
- tests/
...
To be completed as the demo is implemented.
